...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/850619329628471336/866186031841411103/9e03a65f07f0efdebbe291fccd718f4d.gif")
  ...
  try {
      ...
      .setColor("#F0EAD6")
      .setAuthor(`Started playing: ${song.title}`,'https://media.discordapp.net/attachments/850619329628471336/866186031841411103/9e03a65f07f0efdebbe291fccd718f4d.gif?width=624&height=468')
