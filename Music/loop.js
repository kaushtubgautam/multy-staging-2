...
execute(message) {
    ...
    .setAuthor(`Loop is now ${queue.loop ? " enabled" : " disabled"}`, "https://media.discordapp.net/attachments/850619329628471336/866186031841411103/9e03a65f07f0efdebbe291fccd718f4d.gif?width=624&height=468")
