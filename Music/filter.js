...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    const filters = [
      'bass=g=15,dynaudnorm=f=200',//bassboost
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor("Applying: " + args[0], "https://media.discordapp.net/attachments/850619329628471336/866186031841411103/9e03a65f07f0efdebbe291fccd718f4d.gif?width=624&height=468","https://discord.com/api/oauth2/authorize?client_id=767885987740254291&permissions=49572160&scope=bot")).then(msg =>{
